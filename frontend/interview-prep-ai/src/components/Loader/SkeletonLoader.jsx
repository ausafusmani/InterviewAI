    ...
    <div>
      ...
      <div role="status" className="animate-pulse space-y-4 max-w-3xl">
        ...
        <div className="space-y-2">
          ...
          <div className="h-3 bg-gray-200 rounded dark:bg-gray-700 w-8/12"></div>
          <div className="h-3 bg-gray-200 rounded dark:bg-gray-700 w-7/12"></div>
        </div>
      ...
      <div role="status" className="animate-pulse space-y-4 max-w-3xl mt-10">
        ...
        <div className="space-y-2">
          ...
          <div className="h-3 bg-gray-200 rounded dark:bg-gray-700 w-8/12"></div>
          <div className="h-3 bg-gray-200 rounded dark:bg-gray-700 w-7/12"></div>
          <div className="h-3 bg-gray-200 rounded dark:bg-gray-700 w-6/12"></div>
        </div>
      </div>
    </div>
  );
